...
//     // submitted.textContent = "Your test is Submitted successfully";
    
  
//     // Disable further interaction with questions after submission
//     const options = document.querySelectorAll(".option");
//     options.forEach((option) => {
//       option.onclick = null; // Remove onclick event to disable further clicks
//     });
...
//     quizContainer.innerHTML = "Your test is Submitted successfully";
